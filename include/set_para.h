...
void set_data_path(std::string dataset, stkq::Parameters &parameters)
{
    ...
    {
        base_emb_path.append(R"(Msmarco/base_img_emb.fvecs)");
        base_loc_path.append(R"(Msmarco/base_text_emb.fvecs)");
        base_video_path.append(R"(Msmarco/base_video_emb.fvecs)");
        query_emb_path.append(R"(Msmarco/query_img_emb.fvecs)");
        query_loc_path.append(R"(Msmarco/query_text_emb.fvecs)");
        query_video_path.append(R"(Msmarco/query_video_emb.fvecs)");
        query_alpha_path.append(R"(Msmarco/range2d_)" + std::to_string(range) + "_query_alpha.fvecs");
        ground_path.append(R"(Msmarco/range2d_)" + std::to_string(range) + "_top10_results.ivecs");
    }
    else if (dataset == "imagenet")
    {
